...
static void	init_ray(t_ray *ray, t_config *config, int x)
{
    ...
    // cameraX permet de savoir où on se trouve sur le plane(l'écran virtuel)
    // donc cette valeur serait toujours entre -1 et 1
    // 0 rayon central; -1 rayon plus à gauche; 1 rayon tout à droite
    ...
    // Maintenant camearX mélangé avec dix et planex donne la coordonnée x exacte à l'écran
    // Même chose pour la coordonnée y à l'écran
